...
?>
    ...
    $rs = mysqli_query($con, "SELECT actor.`first_name`,actor.`last_name`, film.`title` FROM `film_actor` left join actor on actor.actor_id = film_actor.film_id left join film on film.film_id = film_actor.actor_id ");
//print_r($rs);
$array = mysqli_fetch_all($rs, MYSQLI_ASSOC);
//print_r($array[0]);
$index = 1;
